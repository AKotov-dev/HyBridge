...
The system proxy is configured automatically. Supported DEs: Budgie, GNOME, Cinnamon, MATE, KDE. XFCE and LXDE support system proxy mode when [XDE-Proxy-GUI](https://github.com/AKotov-dev/xde-proxy-gui) is installed.  
