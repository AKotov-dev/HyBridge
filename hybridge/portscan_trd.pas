...
begin
  ...
  try
    ...
    ScanProcess.Parameters.Add(
      '[[ $(ss -ltn | grep 127.0.0.1:' + MainForm.EditLocalSocks.Text +
      ') ]] && echo "yes"');
...
begin
  ...
  begin
    ...
    begin
      ...
      EditLocalSocks.Enabled := False;
      EditLocalHTTP.Enabled := False;
    end
    else
    begin
      Shape1.Brush.Color := clYellow;
      EditLocalSocks.Enabled := True;
      EditLocalHTTP.Enabled := True;
    end;
